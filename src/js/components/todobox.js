    ...
    return (
      <div>
        ...
        <Row>
          ...
          <Col span={12}>
            <Button className="pull-left"><Icon type="user" />   <a href="https://ricesgui.github.io/">小瑰</a></Button>
            <Button className="pull-right"><Icon type="github" />   <a href="https://github.com/ricesgui">ricesgui</a></Button>
          </Col>
        </Row>
        </div>
    )
